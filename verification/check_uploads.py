...
def main() -> None:
    with tempfile.TemporaryDirectory() as directory:
        ...
        manager._request = lambda method, url, **kwargs: (calls.append((method, kwargs.get("data"))) or original_request(method, url, **kwargs))
        ...
        manager._request = lambda method, url, **kwargs: (_ for _ in ()).throw(RuntimeError("network")) if method == "PUT" else Response(200, {"uploadUrl": "https://upload.sharepoint.com/session"})
        try:
