...
def main() -> None:
    ...
    for required in (
        ...
        '"$RUNNER_TEMP/security-tools/bin/pip-audit" .',
        '"$RUNNER_TEMP/security-tools/bin/pip-licenses"',
        '--python="$RUNNER_TEMP/security-runtime/bin/python"',
        'python -m venv "$RUNNER_TEMP/security-runtime"',
        '"$RUNNER_TEMP/security-tools/bin/cyclonedx-py"',
        '"$RUNNER_TEMP/security-tools/bin/cyclonedx-py" environment',
        '"$RUNNER_TEMP/security-runtime/bin/python"',
        'bomFormat == "CycloneDX"',
